  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-[#f7f1e9]/90 backdrop-blur border-b border-[#e3d8c8]">
        <div className="max-w-6xl mx-auto px-5 h-20 flex items-center justify-between gap-4">
          ...
          <Link href={`/${lang}`} className="text-center shrink-0">
            <div className="font-display text-2xl md:text-3xl tracking-[0.25em] text-[#3f372e]">{brand}</div>
            <div className="text-[10px] tracking-[0.3em] uppercase text-[#b08d57]">{subtitle}</div>
          </Link>
      ...
      <footer className="bg-[#efe6d9] border-t border-[#e3d8c8]">
        <div className="max-w-6xl mx-auto px-5 py-12 grid md:grid-cols-3 gap-8 text-sm text-[#6b5f50]">
          <div>
