  ...
  return (
    <>
      ...
      <section className="relative flex flex-col md:flex-row min-h-[60vh]">
        <div className="md:w-[50%] bg-[#f5ede8] flex flex-col justify-center px-8 sm:px-14 md:px-20 py-20">
          <Reveal>
            <p className="text-[10px] tracking-[0.45em] uppercase text-[#b8976a] mb-5">Наша история</p>
            <h1 className="font-display font-light text-5xl md:text-7xl text-[#1a1714] leading-none mb-8">
              О<br/>СТУДИИ
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#2d2520]">
            {site.aboutStats.map((s, i) => (
              <Reveal key={i} delay={i * 60}>
                <div className="bg-[#1a1714] py-10 px-8 text-center">
                  <div className="font-display text-4xl md:text-5xl text-white mb-2">{s.n}</div>
                  <div className="text-[10px] tracking-[0.35em] uppercase text-[#b8976a]">{s.label}</div>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      <section className="py-20 md:py-28 bg-[#f5ede8]">
        <div className="max-w-7xl mx-auto px-6">
          <Reveal>
            ...
            <h2 className="font-display font-light text-4xl md:text-6xl text-[#1a1714] mb-16">ЦЕННОСТИ</h2>
          </Reveal>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#ddd3ca]">
            {[
              ...
              <Reveal key={i} delay={i * 60}>
                <div className="bg-[#f5ede8] p-8 md:p-10">
      ...
      <section className="py-20 bg-[#ede3da]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <Reveal>
            <h2 className="font-display font-light text-4xl md:text-5xl text-[#1a1714] mb-8">
